	...
	<html>
		...
		<body>
			...
			<div class="container">
				...
				<img src="${contextPath}../resources/images/logo3.png" style = "width: 40%;"/>
				</p>
				...
				<div class="conceptbox1">
					...
					<div class="box">
						...
						<h4>어떠한 공간에서도 변함없는 고유의 표정을 가진 가구.</h4>
						<h4>공간의 완성은 가구로부터 시작됩니다.</h4>
					</div>
					<div class="box">
						<h3><strong>Quality</strong></h3>
						<h4>MOOD는 품질을 타협하지 않습니다.</h4>
						<h4>내 가족이 쓸 수 있는 프리미엄 품질의 가구를 고집합니다.</h4>
					</div>
					<div class="box1">
						<h3><strong>Life</strong></h3>
						<h4>즐거움이 가득한 공간, 마음까지 편안하게 쉴수 있는 공간.</h4>
						<h4>당신의 일상이 달라집니다.</h4>
					</div>
				</div>
