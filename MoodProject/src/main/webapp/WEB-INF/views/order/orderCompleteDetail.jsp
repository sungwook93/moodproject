										...
										<td>
											<c:choose>
												<c:when test="${list.review_yn == 'N' and list.userID == member1.userID}">
													...
													<button type="button" class="btn btn-secondary"  onclick="fn_reviewRegisterForm('${orderDTO.order_num}','${list.product_code}');" style = "float : right;" ><strong>리뷰작성하기</strong></button>
												</c:when>
